...
import com.tms.aiims.grievance.payload.requests.AssignGrievance;
...
import com.tms.aiims.grievance.payload.requests.EmpRequest;
...
import com.tms.aiims.grievance.payloads.ApiResponse;
...
//		}
	...
	//assign category to department
		...
		public ResponseEntity<Object> assignResponsibilities(@RequestBody ResponsibilitiesRequest responsibilitiesRequest) {
			try {
				ResponsibilitiesRequest assignedResponsibilities = adminservices.assignResponsibilities(responsibilitiesRequest);
