...
//	@AfterThrowing(
//		pointcut = "execution(* aiims.grievance.portal.controllers.*.*(..))",
//        throwing = "ex"
//    )
//    public void logException(JoinPoint joinPoint, Exception ex) {
//    	String methodName = joinPoint.getSignature().getName();
//        Object[] args = joinPoint.getArgs();
//        log.error("User:{}, got Exception from:{}, with Input parameter values:{}, and getting exception as:{}",getLoggedInUsername(), methodName, Arrays.toString(args), ex.getMessage());
//    } 
	
	// Advice to log exceptions
    
	
     @Pointcut("execution(* com.tms.aiims.grievance.controllers.*.*(..))")
